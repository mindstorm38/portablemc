...
class Installer(standard.Installer):
    ...
    def set_auth_offline(self, uuid: UUID, username: str): ...
    def set_auth_offline_uuid(self, uuid: UUID): ...
    def set_auth_offline_username(self, username: str): ...
    def set_auth_offline_hostname(self): ...
    def set_auth_msa(self, account: None): ...  # TODO:
